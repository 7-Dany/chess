...
func (King) Attacks(attacks []core.Position, from core.Position, ctx core.BoardContext) []core.Position {
...
func (k King) PseudoLegalMoves(moves []core.Move, from core.Position, ctx core.MoveContext) []core.Move {
